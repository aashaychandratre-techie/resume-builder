          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-2xl">
                Create stunning, professional resumes with our AI-powered
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our powerful features help you create professional resumes that
              get noticed by employers and ATS systems.
            </p>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-4 md:p-8">
              ...
              <div className="text-center mt-6">
                ...
                <p className="text-gray-600">
                  See how professionals create stunning resumes in just minutes
                </p>
              </div>
            </div>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>
              &copy; 2024 ResumeBuilder. Made with ❤️ for professionals
              worldwide.
            </p>
          </div>
        </div>
